...
function mail_complete_setup($mail_id,$name)
{
 ...
 $header .= "Content-type: text/html; charset: utf8\r\n";
    ...
    $header.="from:Team Databagg <team@databagg.com>";
    $content="<br>";
$content.="<style>td{ text-align: center; }</style><body style=\"background:#fafafa; margin:0; padding:0; font-family:Georgia, 'Times New Roman', Times, serif;text-align: center;\">
...
<td style='background:url(https://www.databagg.com/mail_images/topborder.jpg) repeat-x; height:5px;'></td>
 ...
 <br> Your DataBagg account is now almost ready.
In order to use maximum features, don&#8217; t forget to install DataBagg on your computer.


<br /><a  target='_blank' style='color:#db3c6e;text-decoration:none' href='https://www.databagg.com/user/databagg.zip'>Download Databagg</a> <br /> 
...
<td style='background:url(https://www.databagg.com/mail_images/topborder.jpg) repeat-x; height:5px;'></td>
  ...
  <td style=\"font-size:13px; border-bottom:1px solid #e5e5e5; font-family:Georgia, 'Times New Roman', Times, serif; color:#333; line-height:22px; padding:15px;\">
  <p style='font-size:16px;   color:black;'>Hi <font style='font-size:16px;   color:#0092c6;font-weight: bold;'>$name,</font> </p> 
 <br> Thanks for choosing DataBagg, my name is <font style='font-size:16px;   color:#0092c6;font-weight: bold;'> $mname </font> and I'll be your first point of contact if you need any help.
...
<td style='background:url(https://www.databagg.com/mail_images/topborder.jpg) repeat-x; height:5px;'></td>
  ...
  <td style=\"font-size:13px; border-bottom:1px solid #e5e5e5; font-family:Georgia, 'Times New Roman', Times, serif; color:#333; line-height:22px; padding:15px;\">
  <p style='font-size:16px;   color:black;'>Hi <font style='font-size:16px;   color:#0092c6;font-weight: bold;'>$name,</font> </p> 
<br> You have fully consumed your DataBagg storage. Upgrade and instantly get more space. <br /> <br />
...
<br>  You have consumed <font style='font-size:14px;   color:#0092c6;font-weight: bold;'>$percent </font> of your available space. Upgrade and instantly get more space.
...
function mail_share($mail_id,$cd,$fnm,$lnm,$mid,$pass)
{
    global $mail;
     $headers = 'From: DATABAGG <team@databagg.com>' . "\r\n";
	$headers .= 'MIME-Version: 1.0' . "\r\n";
	$headers .= 'Content-type: text/html; charset=iso-8859-1' . "\r\n";
    $dest="http://www.databagg.com/user/files/share/?type=web&code=$cd";
...
<br />
File download password is : $pass
 <br />
...
<td style='background:url(https://www.databagg.com/mail_images/topborder.jpg) repeat-x; height:5px;'></td>
  ...
  <td style=\"font-size:13px; border-bottom:1px solid #e5e5e5; font-family:Georgia, 'Times New Roman', Times, serif; color:#333; line-height:22px; padding:15px;\">
  <p style='font-size:16px;   color:black;'>Hi <font style='font-size:16px;   color:#0092c6;font-weight: bold;'>$name,</font> </p> 
<br>  DataBagg has just completed your first data backup.<br /><br />
...
<br/><br />You can access your account by clicking here: <a  style='color:#ea4d0f;text-decoration:none' href='https://www.databagg.com/login.php' target='_blank'> Login to databagg </a>  <br /><br />
...
<br> Congratulations on making a smart decision! <br /> <br />
...
<br /><br />
If you have not downloaded the DataBagg apps for your PC, then please use this link: <a href='https://www.databagg.com/user/databagg.zip' style='font-size:12px;   color:#ea4d0f;font-weight: bold;'>Download databagg</a> <br />
...
$content.="<br> <br>";
	...
	$mail->ClearAllRecipients();
       ...
       //$mail_id="manish.sarthak@cyfuture.com";
       // mail($em_enc, $subject, $content, $header);

}


function mail_welcome_facebook($em_enc,$nm,$pass)
{
    global $mail;
   $headers = 'From: DATABAGG <team@databagg.com>' . "\r\n";
	$headers .= 'MIME-Version: 1.0' . "\r\n";
...
Control Panel: <a href='https://www.databagg.com/login' target='_blank' style='font-size:14px;   color:#ea4d0f;font-weight: bold;'>Click here</a>
<br /><br />
Login Details:
Email: <font style='font-size:14px;   color:#0092c6;font-weight: bold;'>$em_enc</font> <br />
Password: <font style='font-size:14px;   color:#0092c6;font-weight: bold;'>$pass</font>
<br /><br />
<font style=\"font-size:9px;\">Note : This is a system generated password, please change your password. </font>
<br /><br />
If you have not downloaded the DataBagg apps for your PC, then please use this link: <a href='https://www.databagg.com/user/databagg.zip' style='font-size:12px;   color:#ea4d0f;font-weight: bold;'>Download databagg</a> <br />
...
<td style='background:url(https://www.databagg.com/mail_images/topborder.jpg) repeat-x; height:5px;'></td>
  ...
  <td style=\"font-size:13px; border-bottom:1px solid #e5e5e5; font-family:Georgia, 'Times New Roman', Times, serif; color:#333; line-height:22px; padding:15px;\">
  <p style='font-size:16px;   color:black;'>Hi <font style='font-size:16px;   color:#0092c6;font-weight: bold;'>$name,</font> </p> 
 <br> Hope you are going well. I was reading about Data Protection and I came to know few interesting observation that:- <br /> <br />
...
//mail_welcome("manish.sarthak@cyfuture.com","saurav");
//mail_verify("manish.sarthak@cyfuture.com","saurav");
//mail_forgot("manish.sarthak@cyfuture.com","saurav","Pass");
//mail_share("manish.sarthak@cyfuture.com","code","saurav","suman","saurav.suman@cyfuture.com");
//mail_share_category("manish.sarthak@cyfuture.com","code","saurav","suman","saurav.suman@cyfuture.com");
//mail_share_category_photo("manish.sarthak@cyfuture.com","code","saurav","suman","saurav.suman@cyfuture.com");
//mail_share_category_video("manish.sarthak@cyfuture.com","code","saurav","suman","saurav.suman@cyfuture.com");
//
//mail_download_databagg("manish.sarthak@cyfuture.com","saurav");
//mail_data_filled("manish.sarthak@cyfuture.com","saurav","80%","Chiipa jee");
//mail_data_filled_all("manish.sarthak@cyfuture.com","saurav","Chiipa jee");
//mail_done_hard_work("manish.sarthak@cyfuture.com","saurav","Chiipa jee");
//mail_complete_setup("manish.sarthak@cyfuture.com","saurav");
//mail_dedicated_manager("manish.sarthak@cyfuture.com","saurav","Manager");
//mail_first_sync("manish.sarthak@cyfuture.com","saurav","PC123");
?>