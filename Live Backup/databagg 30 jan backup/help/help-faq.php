...
<li>&raquo;</li>
<li class="active"><a href="help-faq.php">FAQ's</a></li>
...
<div class="fl browsetext">Browse by Categories</div>    
    ...
    <h2 class="acc_trigger"><a href="#">How do I cancel my account?<br />
<span>Ryan August 15, 2011</span> </a></h2>

	<div class="acc_container">
		<div class="block">
	
			
			<p>To ensure that your cancellation is addressed immediately please ensure that you follow the below process. Please note that any cancellation requests made through other channels may be missed (and you may continued to get billed.)</p>

<p>Only accounts that have been upgraded from within Data Bagg itself may also cancel from within Data Bagg. If you are a Business or Enterprise user that has signed a contract with Data Bagg, you will not be able to cancel your subscription from within your account.  If this is the case, please contact 

<a href="mailto:cancel@databagg.com">cancel@databagg.com</a>. Otherwise, please follow the steps below:</p>

<p>To ensure that your cancellation is addressed immediately please ensure that you follow the below process. Please note that any cancellation requests made through other channels may be missed (and you may continued to get billed.)To ensure that your cancellation is addressed immediately please ensure that you follow the below process. Please note that any cancellation requests made through other channels may be missed (and you may continued to get billed.)</p>

<p>Only accounts that have been upgraded from within Data Bagg itself may also cancel from within Data Bagg. If you are a Business or Enterprise user that has signed a contract with Data Bagg, you will not be able to cancel your subscription from within your account.  If this is the case, please contact 
Otherwise, please follow the steps below: </p>
		</div>
	</div>
	
	<h2 class="acc_trigger"><a href="#">How do I cancel my account?<br />
    <span>Ryan August 15, 2011 </span></a>
