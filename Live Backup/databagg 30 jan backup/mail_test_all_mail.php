...
<td style='background:url(https://www.databagg.com/mail_images/topborder.jpg) repeat-x; height:5px;'></td>
  ...
  <td style=\"font-size:13px; border-bottom:1px solid #e5e5e5; font-family:Georgia, 'Times New Roman', Times, serif; color:#333; line-height:22px; padding:15px;\">
  <p style='font-size:16px;   color:black;'>Hi <font style='font-size:16px;   color:#0092c6;font-weight: bold;'>$name,</font> </p> 
<br>  DataBagg has just completed your first data backup.<br />
...
mail_complete_setup("manish@sarthaktech.com","saurav");
mail_complete_setup("Jaipurtest2@rediffmail.com","saurav");
mail_complete_setup("Jaipurtest5@yahoo.com","saurav");
mail_complete_setup("Jaipurtest4@yahoo.in","saurav");
mail_complete_setup("Jaipurtest11@gmail.com","saurav");
mail_complete_setup("databagg@aol.com","saurav");
mail_complete_setup("Jaipurtest3@live.co.uk","saurav");
mail_complete_setup("Jaipurtest3@hotmail.com","saurav");
mail_complete_setup("Jaipurtest7@outlook.com","saurav");
//
