    ...
    <center>
       ...
       if($_REQUEST['msg'])
     {
        ...
        <div class="success" id="error_container1">
         <strong>&radic;</strong> Registration Successfull, A verification mail is sended on your email, Please login . 
       ...
       if($_REQUEST['msg_fp'])
     {
        ?>
        <div class="success" id="error_container1">
         <strong>&radic;</strong> Please check your E-mail for further instructions.
       ...
       if($_REQUEST['msg_ver'])
     {
        ?>
        <div class="success" id="error_container1">
         <strong>&radic;</strong> Email verified successfully! Please login with your email-id and password. 
     ...
     <br />
     <style>
     .login_error { width:211px; height:30px;  top:-35px; margin-left:175px; color:#FFF;
      font-family:Verdana, Geneva, sans-serif; padding:5px 0 0 0; background:url(image/errorrmess-img.png) no-repeat;  }
     </style>
...
<span id="error_email" class="login_error" style="display: none;">
&nbsp;Please enter an e-mail
</span> 
<label for="emailaddress">Email Address:  </label>
 <input type="text" id="txt_email" name="txt_email" onkeypress="if(event.keyCode==13) {validate();}" value="Your Email Address" onclick="if(this.value=='Your Email Address')javascript:this.value='';" onfocus="this.select()" class="rightinput" />
<img src="images/starIcon.png"/>


<span id="error_password" class="login_error" style="display: none;">
&nbsp; Please enter password
</span>

<label for="emailaddress" style="margin-top: 5px;">Password: </label>
<input style="margin-top: 5px;" type="password" id="txt_password" name="txt_password" onkeypress="if(event.keyCode==13) {validate();}" value="Your Password" onclick="if(this.value=='Your Password')javascript:this.value='';" onfocus="this.select()" class="rightinput" />
 <img src="images/starIcon.png"/>



 
<div class="forget"><a href="user/forgot_password.php">Forgot Password</a></div><br />
 
     <div class="submit-lnform">
     
     <div class="submit-l"><img src="images/loginin.jpg" width="149" height="50" alt="" onkeypress="if(event.keyCode==13) {validate();}" onclick="validate();" style="cursor: pointer;" /></div>
