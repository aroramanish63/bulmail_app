...
require_once("PHPMailer/class.phpmailer.php");
                    ...
                    $mail->SMTPAuth   = true; 
                    $mail->Host     = "111.118.191.14";  // SMTP server
...
<table width='100%' cellspacing='0' cellpadding='0' border='0'  style='background: url(databagg.com/cnfrm_mail/cloud.jpg) #ABE7FF>
 ...
 $fnm  $lnm  ($mid) shared a  Image Gallary  with you.<br>
 

 Open  the Gallary by clicking on 'View Gallary' <br>
 </p>
 </td>
...
<td width='140' align='right' style='padding:20px'>
 ...
 <span style='padding:9px 15px;color:#fcf9f9;text-decoration:none;color:#fcf9f9;font-family:'helvetica neue',helvetica,arial,sans-serif;font-weight:bold;font-size:18px;line-height:18px;white-space:nowrap'>View Gallary</span>
...
//	$mail->Host     = "192.168.100.7"; 
	$mail->SetFrom("support@databagg.com","DATABAGG");
	$mail->Subject  = "Databagg Image Gallary Share";
	$mail->MsgHTML($content);
...
<table width='100%' cellspacing='0' cellpadding='0' border='0'  style='background: url(databagg.com/cnfrm_mail/cloud.jpg) #ABE7FF>
 ...
 $fnm  $lnm  ($mid) shared a  Video Gallary  with you.<br>
...
//	$mail->Host     = "192.168.100.7"; 
	$mail->SetFrom("support@databagg.com","DATABAGG");
	$mail->Subject  = "Databagg Video Gallary Share";
	$mail->MsgHTML($content);
