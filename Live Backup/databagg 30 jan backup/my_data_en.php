...
//pagination
	...
	$targetpage = "https://www.databagg.com/user/index.php?name_page=my_data"; 	
	$limit = 3; 
    if ($_SESSION['page_type']=="gallary")
    {
      $condition=" lower(SUBSTRING_INDEX(`txt_file_name`,'.',-1)) in ('png','bmp','jpg','jpeg','gif') ";    
    }
    else if ($_SESSION['page_type']=="video")
    {
      $condition=" lower(SUBSTRING_INDEX(`txt_file_name`,'.',-1)) in ('flv','wmv','mp4','mpg','avi','3gp','mov') ";  
    }
    else
    {
       $condition=" lower(SUBSTRING_INDEX(`txt_file_name`,'.',-1)) in ('mp3','wav') ";     
    }
	if($_REQUEST['s'])
    {
...
?>
    ...
    border-radius:3px;
        ...
        .brt_ren{
           background:url(https://www.databagg.com/user/images/buttonbg.jpg) repeat-x;
		   width:auto;
		   height:33px;
		   border:none;
	...
	border:1px solid #007286;
        ...
        .brt_ren:hover{ /*background-position:left -33px;*/ background:url(https://www.databagg.com/user/images/buttonbg_hov.jpg) repeat-x; border:1px solid #8aa314;}
        .txt_ren{
    ...
    box-shadow: 0 1px 1px rgba(0, 0, 0, 0.3), 0 0 0 #000000 inset;
        ...
        <link rel="stylesheet" href="https://www.databagg.com/user/css/prettyPhoto.css" type="text/css" media="screen" title="prettyPhoto main stylesheet" charset="utf-8" />

		<script src="https://www.databagg.com/user/js/jquery.prettyPhoto.js" type="text/javascript" charset="utf-8"></script>
<link href='https://fonts.googleapis.com/css?family=PT+Sans:400' rel='stylesheet' type='text/css'>
			<script type="text/javascript" charset="utf-8">
            var $l = jQuery.noConflict();   
			$l(document).ready(function(){
				$l("area[rel^='prettyPhoto']").prettyPhoto();
				
				$l(".gallery:first a[rel^='prettyPhoto']").prettyPhoto({animation_speed:'normal',theme:'light_square',slideshow:3000, autoplay_slideshow: true});
				$l(".gallery:gt(0) a[rel^='prettyPhoto']").prettyPhoto({animation_speed:'fast',slideshow:10000, hideflash: true});
...
<link href="https://www.databagg.com/user/css/ui-lightness/jquery-ui-1.8.14.custom.css" rel="stylesheet" type="text/css" />
<link href="https://www.databagg.com/user/css/fileUploader.css" rel="stylesheet" type="text/css" />

<script src="https://www.databagg.com/user/js/jquery-1.6.2.min.js" type="text/javascript"></script>
<script src="https://www.databagg.com/user/js/jquery-ui-1.8.14.custom.min.js" type="text/javascript"></script>
<script src="https://www.databagg.com/user/js/jquery.fileUploader.js" type="text/javascript"></script>

<script type="text/javascript" src="https://www.databagg.com/user/js/prototype.js"></script>
<script type="text/javascript" src="https://www.databagg.com/user/js/scriptaculous.js?load=effects,builder"></script>
<!--<script type="text/javascript" src="https://www.databagg.com/user/js/lightbox.js"></script> -->
<link rel="stylesheet" href="https://www.databagg.com/user/css/lightbox.css" type="text/css" media="screen" />

<link rel="stylesheet" type="text/css" href="https://www.databagg.com/user/css/balloontip.css" />
<link href="https://www.databagg.com/user/css/dropdown.css" media="screen" rel="stylesheet" type="text/css" />
<link href="https://www.databagg.com/user/css/default.advanced.css" media="screen" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="https://www.databagg.com/user/js/balloontip.js"></script>
<script>
	var xmlhttp;
function testXML(){
...
{   //alert("sasa");  
    ...
    //var lastclass="<?php if($_SESSION['class_list']) echo $_SESSION['class_list']; else echo "field1"; ?>";
		var strURL="https://www.databagg.com/user/ajax_change_class.php?add="+str;
        //alert(strURL);
		var req = testXML();
...
<div id="div_restrict" class="white_content2" >
       ...
       <img src="https://www.databagg.com/user/image/close_u.png" />
        ...
        <td valign='top'>
         <b style="color:#E85005"> Unverified Account !  Please Verify it or <a href='https://www.databagg.com/user/index.php?name_page=my_data&mail=em_enc' > Resend Email </a>  </b> 
         <br />
        ...
        <img src="https://www.databagg.com/user/images/alert.png" style="position: absolute;margin-top: -45px;" />
 </div>
 ...
 <?php
       ...
       if($_REQUEST['err'])
     {
        ...
        <div class="error" id="error_container2">
         <strong>×</strong> <?php echo "File already exists. Please try with another name"; ?>
...
<div class="fleft large_social">
	...
	<a class="large" href="javascript:changeView('small-field1')" rel="balloon2">Medium</a>
	<a class="extra_large" href="javascript:changeView('large-field1')" rel="balloon3">Large</a>
</div>
...
<!--<form action="#" id="searchform" method="post">
            <fieldset id="search">
                ...
                <input type="image" class="btn" id="searchsubmit" value="Search" src="{$cfg['user_image_url']}btn-search.gif" onmouseover="this.src='{$cfg['user_image_url']}search_icon.gif';" onmouseout="this.src='{$cfg['user_image_url']}btn-search.gif';" name="" style="margin-left:-5px;">
            </fieldset>
...
<div class="fleft width" style="margin-top:23px;">
<hr>
...
<button id="delete" class="brt_ren" style="margin-bottom: 12px;" >
<?php if ($_SESSION['page_type']=="gallary") { 
echo "Create Album";
}
else if ($_SESSION['page_type']=="video") {
...
<link rel="stylesheet" href="https://www.databagg.com/user/css/tipsy.css" type="text/css" />
...
<form id="form1" name="form1" action="#" method="post">
       ...
       <td colspan="2"> 
                ...
                <select class="txt_ren"  title="Select one or more item" size="<?php echo $total_pages+1; ?>" multiple="multiple" name="select_item[]" id="select_item" style="margin-left: 5px;font-family: 'PT Sans',sans-serif;max-height: 250px;">
                <?php
       ...
       <input style="<?php  if ($_SESSION['page_type']=="video") echo "margin-left:111px;"; else echo "margin-left:80px;"; ?> margin-bottom:72px;" class="brt_ren" type="button" onClick="val_new_item()" value=" <?php
                if ($_SESSION['page_type']=="gallary")
                echo "Create Album";
                else if ($_SESSION['page_type']=="video")
                echo "Create Video Gallary";
       ...
       <?php
                ...
                <div class="tipsy-inner"><b>No data available related to this section, Please upload first from my databagg tab.</b></div></div>
                <br />
                <?php
                }
               ?>
...
<script src="https://www.databagg.com/user/js/jquery.cycle.all.latest.js"></script>
<script type="text/javascript">
$(document).ready(function() {
    $.getScript('https://www.databagg.com/user/js/jquery.cycle.all.latest.js', function(){
    $('.slideshow').cycle({
...
<link href="https://www.databagg.com/user/css/video-js.css" rel="stylesheet">
<script src="https://www.databagg.com/user/js/video.js"></script>
...
<?php if ($_SESSION['page_type']=="gallary") { ?>
<img src="https://www.databagg.com/user/images/album-1.png" />
<?php } else if ($_SESSION['page_type']=="video") { ?>
<img src="https://www.databagg.com/user/images/video.png" />
<?php }  
else { ?>
<img src="https://www.databagg.com/user/images/audio.png" />
<?php } ?>
...
<div style="float:right; ">
       ...
       <ul id="nav" class="dropdown dropdown-horizontal">
                               ...
                               <li><a href="javascript:void(0);" class="delete_dropdownt"></a>
                                       <ul class="position">
                                               
                                            
                                               <li> <a class="delete"  href="javascript:void(0);" onClick="verify1('<?php echo $fetch_playlist_file['int_cat_id']; ?>')"  > 
                                               <img  src="https://www.databagg.com/user/images/delete.png" style="width: 10px; height: 10px; " align='texttop' /> Delete </a></li>
                                               <?php
                                                 if($fetch_user_data['int_verified']==0)
                                                 {
                                                    ?>
                                                     <li> <a class="delete"  href="javascript:restrict();"  > 
                                               <img  src="https://www.databagg.com/user/images/icon_share.gif" style="width: 10px; height: 10px; " align='texttop' /> Share </a></li>
                                                    <?php
                                                 }
                                                 else
                                                 {
                                               ...
                                               <img  src="https://www.databagg.com/user/images/addmore.png" style="width: 10px; height: 10px; " align='texttop' /> Add More </a></li>
                                               ...
                                               <img  src="https://www.databagg.com/user/images/list-all.png" style="width: 10px; height: 10px; " align='texttop' /> List All </a></li>
	...
	width:29px; height:29px; display:block; float:left; text-indent:-9999px; background:url(https://www.databagg.com/user/image/sprite.png) no-repeat -210px -69px; margin:0 4px 0 0;}
    .field1 .share_btns a.pbut:hover{
	width:29px; height:29px; display:block; float:left; text-indent:-9999px; background:url(https://www.databagg.com/user/image/sprite.png) no-repeat -246px -69px; margin:0 4px 0 0;}
    .small-field1 .share_btns a.pbut{
	width:19px; height:18px; display:block; float:left; text-indent:-9999px; background:url(https://www.databagg.com/user/image/sprite.png) no-repeat -133px -100px; margin:0 2px 0 0;}
    .small-field1 .share_btns a.pbut:hover{
	width:19px; height:18px; display:block; float:left; text-indent:-9999px; background:url(https://www.databagg.com/user/image/sprite.png) no-repeat -153px -100px; margin:0 2px 0 0;} 	
	...
	width:19px; height:18px; display:block; float:left; text-indent:-9999px; background:url(https://www.databagg.com/user/image/sprite.png) no-repeat -153px -100px; margin:0 2px 0 0;}
                   ...
                   <?php if ($_SESSION['page_type']=="gallary") { ?>
                                                   ...
                                                   <a title="Play this video gallary"  class="pbut" href="javascript:void(0);" onClick="open_list_div('<?php echo $fetch_playlist_file['txt_fid']; ?>','<?php echo $fetch_playlist_file['txt_cat_name']; ?>','<?php echo totalfile($fetch_playlist_file['txt_fid']); ?>');" > play </a>
                                                    <?php } else
                                                    {
                                                        ?>
...
<?php if($fetch_data['txt_file_type']=="application/pdf") { ?>
                    <a href="https://www.databagg.com/user/download.php?path=../nas/uploads/<?php echo $fetch_data['txt_file_name']; ?>"> 
                    <?php 
                    }
...
<img  src="https://www.databagg.com/user/images/add-tiny-white.gif" style="width: 10px; height: 10px; " align='texttop' /> Add to Album </a>
<?php } 
else if ($_SESSION['page_type']=="video") { ?>
<a href="javascript:void(0);" onClick="open_rename_div('<?php echo $fetch_data['int_fid'];  ?>','<?php echo $fetch_data['txt_file_name'];  ?>')"> 
<img  src="https://www.databagg.com/user/images/add-tiny-white.gif" style="width: 10px; height: 10px; " align='texttop' /> Add to Video Gallery </a>
<?php }
else { ?>
<a href="javascript:void(0);" onClick="open_rename_div('<?php echo $fetch_data['int_fid'];  ?>','<?php echo $fetch_data['txt_file_name'];  ?>')"> 
<img  src="https://www.databagg.com/user/images/add-tiny-white.gif" style="width: 10px; height: 10px; " align='texttop' /> Add to playlist </a>
<?php } ?>
                                               </li>
...
<img src="https://www.databagg.com/user/image/nofile_found.jpg" />
</div>
    <?php
    }
...
#search input {
    background: url("https://www.databagg.com/user/images/search-bgr.gif") repeat-x scroll center top transparent;
...
<div>
	...
	<script>!window.jQuery && document.write(unescape('%3Cscript src="https://www.databagg.com/user/js/minified/jquery-1.9.1.min.js"%3E%3C/script%3E'))</script>
	<!-- custom scrollbars plugin -->
	<script src="https://www.databagg.com/user/js/jquery.mCustomScrollbar.concat.min.js"></script>
	<script>
    function rn()
    {
     var $p = jQuery.noConflict();  
				...
				$p("#loading_container").mCustomScrollbar({
					scrollButtons:{
						enable:true
					}
				});
     ...
     <!--    <div class="music_pattern listdiv" id="list_div" style="display: none;width: 810px;border-radius: 0; border: 1px solid #78B0DE;
            box-shadow: 0 0 5px #78B0DE;margin: 0px;padding: 0px;">
            <font class='heading_t' style='background-color: #15a0c8;width: 100%;float: left;color:#fff;padding-top: 5px;padding-bottom: 5px;' >VIDEO PLAYLIST </font>
          <div class="music_close" onClick="document.getElementById('dynamic_vdo').src ='';document.getElementById('list_div').style.display='none';">
          <img src="https://www.databagg.com/user/image/close_u.png" alt="close" style="cursor: pointer;" /></div>
         <br />
         <div id="loading_container" style="width:300px;float: left;">
  
    <img src="https://www.databagg.com/user/images/ajax-loader.gif"/>
    <br />
    Loading..
            
 </div>
 <div id="play_container" style="float: left; background: #fff;">
 <iframe id="dynamic_vdo"  src="test_vdo.php" style="width: 500px;height: 360px;"></iframe>
 </div>  -->
    ...
    <script>
    function go(loc){
    document.getElementById('dynamic_vdo').src = "https://www.databagg.com/user/test_vdo.php?name="+loc;
}
    </script>
 ...
 <div class="music_close" ><img src="https://www.databagg.com/user/image/close_music.png" style="cursor: pointer;"  onclick="document.getElementById('rename_div').style.display='none';" /></div>
 ...
 <p>Add to <?php if ($_SESSION['page_type']=="gallary") echo "Album: "; else if ($_SESSION['page_type']=="video") echo "Video: "; else echo "Playlist: "; ?> 
  <select   class="select_box" id="playlist_name" name="playlist_name" onChange="enable_disable(this.value);">
    ...
    <p> Custom <?php if ($_SESSION['page_type']=="gallary") echo "Album "; else if ($_SESSION['page_type']=="video") echo "Video Gallery "; else echo "Playlist "; ?> Name 
...
margin-left: 635px;
    ...
    <input type="hidden" id="refresh_cond" />
        ...
        <link href="https://www.databagg.com/user/css/video.css" type="text/css" rel="stylesheet" />
<link href="https://www.databagg.com/user/css/jquery.mCustomScrollbar.css" rel="stylesheet" />
<div id="container_video" style="display: none;">
        <div class="wrap_video" >
<div class="toprowvideo">
<h1>Video Playlist</h1>
</div>

<div class="videooutoor">
<div class="leftvideosection" >
<h2><span id="nm_v_gal" style="font-size: 20px;"> Wildcare Album </span> / <span id="tot_v_gal">8 </span><span>  videos</span></h2>
<div class="close_vidbtn"><a href="javascript:void(0);" onClick="document.getElementById('dynamic_vdo').src ='';document.getElementById('container_video').style.display='none';document.getElementById('fade_vid').style.display='none'; "><img src="https://www.databagg.com/user/images/videoclose.jpg"  alt="#" /></a></div>
<div class="scrollersection" id="loading_container">

</div>
</div>
<div class="rightvideosection"><iframe id="dynamic_vdo"  src="https://www.databagg.com/user/test_vdo.php" style="width: 500px;height: 360px;"></iframe></div>
</div>
</div>
</div>
<div id="fade_vid" class="black_overlay_vid"></div>
</body>
...
<script>
function open_list_div(cat_id,cat_nm,tot_file)
{
   document.getElementById('fade_vid').style.display='block'; 
   document.getElementById('container_video').style.display='block'; 
    document.getElementById('nm_v_gal').innerHTML=cat_nm;
    document.getElementById('tot_v_gal').innerHTML=tot_file;
   load_data(cat_id);
...
{
    location.href="https://www.databagg.com/user/home.php?dir="+id;
}
function autoHide()
...
{
		var strURL="https://www.databagg.com/user/ajax_load_list.php?cat_id="+str;
...
{
		var strURL="https://www.databagg.com/user/ajax_load_list_music_image.php?cat_id="+str+"&main_id="+strid;
        //alert(strURL);
		var req = testXML();
				...
				if (req.readyState == 4) {
					...
					if (req.status == 200) {
                        ...
                        else
                        {
                            ...
                            document.getElementById('light').innerHTML='<a style="margin-left: 575px;"  href = \'javascript:void(0)\' onclick = "document.getElementById(\'light\').style.display=\'none\';document.getElementById(\'fade\').style.display=\'none\';rld();"><img src="https://www.databagg.com/user/image/close_u.png" > </a><br>';
...
{
		var strURL="https://www.databagg.com/user/ajax_add_list_music_image.php?cat_id="+str+"&main_id="+strid+"&condition="+condition;
        //alert(strURL);
		var req = testXML();
...
function create_slide(str)
{
    	...
    	var strURL="https://www.databagg.com/user/ajax_create_slide_show.php?cat_id="+str;
				...
				if (req.readyState == 4) {
					...
					if (req.status == 200) {
                        ...
                        else
                        {
                          ...
                          $l.prettyPhoto.open(vl,api_titles,api_descriptions);
...
<link href='https://www.databagg.com/user/files/fonts/font.css' rel='stylesheet' type='text/css'>
...
.delhov:hover{
    background: url(https://www.databagg.com/user/image/delete_hover.png);
}
.addhov:hover{
   background: url(https://www.databagg.com/user/image/addmore_hover.png); 
}
...
{
		var strURL="https://www.databagg.com/user/ajax_remove_list.php?id="+str+"&cat_id="+category_id;
//alert(strURL);
		var req = testXML();
...
{
		var strURL="https://www.databagg.com/user/ajax_add_list.php?id="+str+"&cat_id="+category_id;
//alert(strURL);
		var req = testXML();
