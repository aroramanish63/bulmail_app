...
<input type="hidden" value="<?php echo $_REQUEST['name_page']; ?>" id="name_page" name="name_page" />	
 ...
 Confirm password mismatch
        ...
        <input type="hidden" value="<?php echo $_REQUEST['name_page']; ?>" id="name_page" name="name_page" />
                           ...
                           <b>
                           You can earn upto 100GB more space by referring your friends to Databagg!
                           </b>
                           </font>
                           
                           
                           <div class="fleft contact_info" style="margin-left:135px;">
                           
                           <img src="images/banner-reffrla.png" style='margin-top: 20px;' />
                           ...
                           {
                           ?>
                            <table  style="width: 100%;margin-top: 20px;" id='alternatecolor' class='altrowstable '>
                           <tr>
                            <th>
                           Type
                            </th>
