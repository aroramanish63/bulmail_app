...
<body style="overflow-x:hidden;font-family: 'PT Sans', sans-serif;">
...
<p class="fright"><?php echo total_space_used(); ?> MB / <?php echo allocatted_space(); ?> MB</p>
<div class="fleft rang">
<div class="yello" style="width: <?php echo number_format(round((total_space_used()*100)/allocatted_space()))."%"; ?>;"></div>
</div>
</div>
