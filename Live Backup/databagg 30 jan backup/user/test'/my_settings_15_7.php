...
<script type="text/javascript" src="js/jquery.js"></script>
  <style>
     .login_error { min-width:211px; height:30px;  top:380px;  color:#FFF;margin-left: 120px;
      font-family:Verdana, Geneva, sans-serif; padding:5px 0 0 20px; background:url(image/errorrmess-img.png) no-repeat; position: absolute; background-size: 100% 30px; }
     </style>
...
<div id="AC_import" class="width fleft" style="margin-top:45px;">
...
<input type="hidden" value="<?php echo $_REQUEST['name_page']; ?>" id="name_page" name="name_page" />	
 ...
 <a href="javascript:void(0);" onclick="javascript:opendialogbox('picture');" style="text-decoration: none;color: white;">
                            ...
                            <div id="test" class="chk_msg_change"  ></a>
                             </div>
 <?php } ?>
 ...
 Enter your zip-code
       ...
       <input type="text" id="txt_zip" name="txt_zip" value="<?php echo $fetch_user_data['txt_zip']; ?>"  class="input_box1"  />
        ...
        <input type="button" value="" onclick="validate();"  class="submit2">
 ...
 Enter old password
        ...
        <input class="input_box1"  type="password" id="pass_prev" name="pass_prev"  /> 
 ...
 Confirm password mismatch
        ...
        <input type="hidden" value="<?php echo $_REQUEST['name_page']; ?>" id="name_page" name="name_page" />
                                                                                  ...
                                                                                  <p class="width" >
                           <font style='margin-left:135px' color='#049CD4'>
                           <b>
                           ...
                           <div class="fleft contact_info" style="margin-left:30px;">
                             ...
                             <img src="images/refferal-banner.png"  alt="#" /></div>
                           <?php
                         ...
                         {
                            ?>
                            <div class="info_err" style="margin-top:70px;">
                            You did not invite your any friend yet.
                            </div>
                            <?php
                         }
                         ?>
                         <a class="submit2" style="margin-left: 530px;padding: 7px;" href="../refral/invite.php" target="_blank" >
                         Get More Referral
                        </a>
                         </p>
...
.submit2{
   /* background:#6eb016;
	...
	width:89px;
	height:32px;
	background:url(images/but-update.png) no-repeat;
	border:none;
	font-family: 'PT Sans', sans-serif;
...
function check_submit()
{
    ...
    document.getElementById('error_pass').innerHTML="Enter new password.";
    ...
    $('#error_pass').fadeIn('slow');
        document.getElementById('error_pass').innerHTML="Please enter a password between 8 and 20 characters long.";
        document.getElementById("Password").focus();
        return false;
    }
			...
			req.onreadystatechange = function() {
				...
				if (req.readyState == 4) {
					...
					if (req.status == 200) {
                        ...
                        $('#error_opass').fadeIn('slow');
                         document.getElementById('error_opass').innerHTML="Old password mismatch";
                        document.getElementById("pass_prev").focus();
                            return false;
...
function validate()
{
    ...
    if(trim_string_str(document.getElementById("txt_first_name").value).length>25  )
    {
     ...
     $('#error_fname').fadeIn('slow');
         document.getElementById("error_fname").innerHTML="First name must be less than 25 characters."
          $("html, body").animate({ scrollTop: 0 }, 600);
        document.getElementById("txt_first_name").focus();
        return false;
    }
     ...
     if(trim_string_str(document.getElementById("txt_last_name").value).length>25  )
    {
      ...
      $('#error_lname').fadeIn('slow');
         document.getElementById("error_lname").innerHTML="Last name must be less than 25 characters.";
         $("html, body").animate({ scrollTop: 0 }, 600);
        document.getElementById("txt_last_name").focus();
        return false;
    }
