...
<form id="form1" name="form1" action="#" method="post">
       ...
       &nbsp;
                ...
                <td>
                <input type="text" name="pl_name" id="pl_name" class="txt_ren" style="margin-left: 5px;" />
                </td>
       ...
       <?php
                ...
                <div class="tipsy-inner"><b>No data available related to this section, Please upload first.</b></div></div>
                <br />
                <?php
                }
               ?>
...
<div style="float:right; ">
	...
	width:19px; height:18px; display:block; float:left; text-indent:-9999px; background:url(../image/sprite.png) no-repeat -6px -100px; margin:0 2px 0 0;} 	
       </style>
...
else
{
     if ($_SESSION['page_type']=="gallary")
                ...
                $dt="Playlist";
    echo " <div class='fieldn'  > <center> <br> <br> <div class='error' style='width:500px;'> You currently don't have any $dt. Create your first $dt now. </div> </center></div>" ;
}
}
?>
<?php
