...
{  
    ...
    $select_data="select * from users_data where int_is_sync=0 and int_uid='".$_SESSION['user_id']."' and int_status=1 and txt_file_name like '%".$_REQUEST['s']."%' and int_del_status=0 and int_pid='".safe($_REQUEST['dir'])."'  order by int_is_folder desc,txt_file_name asc";
    else if($_SESSION['sorting_opt']==3)
    $select_data="select * from users_data where int_is_sync=0 and int_uid='".$_SESSION['user_id']."' and int_status=1 and txt_file_name like '%".$_REQUEST['s']."%' and int_del_status=0 and int_pid='".safe($_REQUEST['dir'])."'  order by int_is_folder desc,txt_last_modified desc";
    else
    $select_data="select * from users_data where int_is_sync=0 and int_uid='".$_SESSION['user_id']."' and int_status=1 and txt_file_name like '%".$_REQUEST['s']."%' and int_del_status=0 and int_pid='".safe($_REQUEST['dir'])."'  order by int_is_folder desc,int_file_size desc ";
...
else
{
    ...
    if($_SESSION['sorting_opt']==2)
     $select_data="select * from users_data where int_is_sync=0 and int_uid='".$_SESSION['user_id']."' and int_status=1 and txt_file_name like '%".safe($_REQUEST['s'])."%' and int_pid=0 and int_del_status=0 order by int_is_folder desc,txt_file_name asc";
    else if($_SESSION['sorting_opt']==3)
     $select_data="select * from users_data where int_is_sync=0 and int_uid='".$_SESSION['user_id']."' and int_status=1 and txt_file_name like '%".safe($_REQUEST['s'])."%' and int_pid=0 and int_del_status=0 order by int_is_folder desc,txt_last_modified desc";
    else
     $select_data="select * from users_data where int_is_sync=0 and int_uid='".$_SESSION['user_id']."' and int_status=1 and txt_file_name like '%".safe($_REQUEST['s'])."%' and int_pid=0 and int_del_status=0 order by int_is_folder desc,int_file_size desc";
...
if(!$result_data)
handle_mysql_error($select_data,"Error while sub directory listing ".date("d/m/y h:i:s",time()),"home");  
...
function dirStructure($pid)
	...
	while($pid!=0)
        ...
        if(!$result)
        handle_mysql_error("Select int_pid,txt_file_name from users_data where int_fid=$pid","Error while sub directory listing-dirstructure ","home");  
