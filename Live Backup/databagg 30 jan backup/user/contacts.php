...
<table cellspacing="1" class="tablesorter_bg" >
	<thead>
		<tr>
			<th width="33%" style="padding-left:10px;">Name</th>
			<th width="33%">Email Address</th>
			<th width="33%" align="right" style="padding-right:10px;">Actions</th>	
...
?>
        <tr>
			<td width="33%" valign="middle"><?php echo $fetch_list['txt_contact_name']; ?></td>
			<td width="33%" valign="middle"><?php echo $fetch_list['txt_contact_email']; ?></td>
			<td width="33%" align="right" style="padding-right:10px;"><a href="javascript:cnfrm_del(<?php echo $fetch_list['int_contact_id'];  ?>);"><img src="image/delete.png" title="Delete Contact" style="margin-top: 3px;" /> </a></td>
...
.tablesorter_bg tr:nth-child(even) {background: #f0f0f0; border:1px solid #e6e6e6;}
.tablesorter_bg tr:nth-child(odd) {background: #FFF}
.tablesorter_bg tr td, .tablesorter_bg thead tr th  { padding:5px 20px 5px 20px !important; font-size:13px;}
