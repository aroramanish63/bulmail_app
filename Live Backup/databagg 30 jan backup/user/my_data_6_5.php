...
//pagination
    ...
    {
      $condition=" lower(SUBSTRING_INDEX(`txt_file_name`,'.',-1)) in ('flv','wmv','mp4','mpg','avi','3gp') ";  
    }
    else
    {
...
<form id="form1" name="form1" action="#" method="post">
       ...
       &nbsp;
                ...
                <select class="txt_ren" style="margin-left: 5px;font-family: 'PT Sans',sans-serif;" title="Select one or more item" size="<?php echo $total_pages+1; ?>" multiple="multiple" name="select_item[]" id="select_item">
                <?php
