...
include("../include_user/funcs/display_functions.php");
error_reporting(0);
...
if(isset($_REQUEST["name_page"]))
	$pagename=mysql_real_escape_string(str_replace(" ","",$_REQUEST["name_page"])).".php";
...
<body style="overflow-x:hidden;font-family: 'PT Sans', sans-serif;" onLoad="do_init();">

<script>
var mydiv_rightpos=-220; var mydiv_fluc=220; var mydiv_timer;
function moveMyDiv()
                {
                     document.getElementById('mv_img').src='images/closearrow.png';
                if(mydiv_rightpos<0)
                                {
...
function closeMyDiv()
                {
                    document.getElementById('mv_img').src='image/open.png';
...
<div id="mydiv1">
  <div style="float: left;margin-top: 50px;"><img id="mv_img" src="image/open.png" width="33"  height="44" onMouseOver="moveMyDiv()"></div>
                  <span class="rightbox">
<div class="bg_slider">
...
<p class="fright"><?php echo size_cal(get_total_consumed_space($_SESSION['user_id'])); ?>  / <?php echo size_cal(allocatted_space()); ?> </p>
...
<div class="grey_row">
<a class="upgrade" href="https://www.databagg.com/pricing.php" target="_blank"></a>
<a class="createticket" href="https://www.databagg.com/extlinks/?layer=http&siteid=ticket.databagg.com" target="_blank"></a>
</div>
</div>
<!--
<div class="box_color">
...
<h3 class="italic fleft">What's New</h3>
</div>

<div class="fleft yello_rang2">
<div class="grey_row2">
 <ul id="mycarousel" class="jcarousel-skin-tango">

<li > <a href="https://play.google.com/store/apps/details?id=com.databagg&amp;hl=en" class="androidicon" target="_blank"></a></li>
 <li>
<a href="https://itunes.apple.com/in/app/databagg/id690003649?mt=8" class="iphoneicon" target="_blank"></a>

</li>
<li>
<a href="http://www.windowsphone.com/en-us/store/app/databagg/51fc8961-1be8-457b-9d9a-9029f5a01914" class="windowicon" target="_blank"></a>

</li>

<li>
<a href="#" class="blackberryicon" target="_blank"></a>
...
<ul class="right_link">
<li><a href="../DataBagg Quick Start.pdf" target="_blank">Quick start guide</a></li>

</ul>
</div>
<div class="pattern_right_slider fleft">
<div class="cmpy_contact fleft"></div>
<h3 class="italic fleft">Support</h3>
</div>
<div class="box_color">
<h4>Futuristic Internet Services LLC . 
</h4>
<h5>#1888-885-4570<br>
<span class="blue">@ - 
<a href="mailto:sales@databagg.com">sales@databagg.com </a> <br /> <br />
...
<div class="fleft">
    ...
    <ul class="index_tab clearfix">
                          <li class="<?php if($_REQUEST['name_page']=='my_sync') echo "active_leftmenu"; else echo "index_tab1"; ?>"><a href="index.php?name_page=my_sync">          
                            ...
                            <div class="fleft" style="margin:10px 5px 0 0;"><img src="image/my_databagg_icon.png"  alt="" /></div>My DataBaGG<br />
                           ...
                           My Settings<br />
                            ...
                            <li class="index_tab1"><a href="https://www.databagg.com/help/index.php" target="_blank">          
...
function check_sess_all()
{
		var strURL="ajax_check_sess.php";
				...
				if (req.readyState == 4) {
					...
					if (req.status == 200) {
                        ...
                        if(req.responseText=="fail")
                        {
                          ...
                          window.location.href='../login.php?err_sess=1';
...
function do_init()
{
    setInterval("check_sess_all()", 5000);
}
</script>


<!--right panel slider start here-->
<script src="js/jquery.jcarousel.min.js" type="text/javascript"></script>
<link rel="stylesheet" href="css/rightpanelslider.css" type="text/css" >
<script type="text/javascript">
