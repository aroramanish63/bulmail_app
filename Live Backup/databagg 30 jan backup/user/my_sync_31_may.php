...
<?php  if($fetch_data['txt_file_type']=="folder")
                 ...
                 >   
                  ...
                  ?>
<img src="<?php if($level_current==1) echo"images/computer-icon.png"; else  echo get_file_thumb($fetch_data['txt_file_type'],$fetch_data['txt_file_name']); ?>" />  </a>
...
<div class="icon_sep" >
 ...
 <img  src="images/skin-icon-rename.png" style="width: 10px; height: 10px; " align='texttop' />&nbsp; rename </a>
      ...
      <div class="share_btns" style="display:<?php  if($level_current>=3) echo "block"; else echo "none"; ?>">
