...
?>
    ...
    text-align: center;
	padding:0 5px 0 5px;
	border:1px solid #307686;
   
   
        }
        .brt_ren:hover{ /*background-position:left -33px;*/ background:url(images/buttonbg_hov.jpg) repeat-x; border:1px solid #8aa314;}
        .txt_ren{
...
<div id="div_restrict" class="white_content2" >
       ...
       <img src="image/close_u.png" />
        ...
        <td valign='top'>
         <b style="color:#E85005"> Unverified Account !  Please Verify it or <a href='index.php?name_page=my_data&mail=em_enc' > Resend Email </a>  </b> 
         <br />
...
<div>
    ...
    function rn()
    {
     ...
     <!--    <div class="music_pattern listdiv" id="list_div" style="display: none;width: 810px;border-radius: 0; border: 1px solid #78B0DE;
          ...
          <img src="image/close_u.png" alt="close" style="cursor: pointer;" /></div>
         <br />
...
<div class="close_vidbtn"><a href="javascript:void(0);" onClick="document.getElementById('dynamic_vdo').src ='';document.getElementById('container_video').style.display='none';document.getElementById('fade_vid').style.display='none'; "><img src="images/videoclose.jpg"  alt="#" /></a></div>
<div class="scrollersection" id="loading_container">

</div>
</div>
<div class="rightvideosection"><iframe id="dynamic_vdo"  src="test_vdo.php" style="width: 500px;height: 360px;"></iframe></div>
</div>
</div>
</div>
