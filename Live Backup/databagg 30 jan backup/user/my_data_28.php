...
//pagination
    ...
    if ($_SESSION['page_type']=="gallary")
    {
      $condition="txt_file_type in ('image/jpeg','image/png','image/gif','image/jpg')";  
    }
    else if ($_SESSION['page_type']=="video")
    {
      $condition="txt_file_type in ('video/mp4')";  
    }
    else
    {
       $condition="txt_file_type in ('audio/mpeg','audio/x-wav')";   
    }
	if($_REQUEST['s'])
    {
...
<?php if ($_SESSION['page_type']=="gallary") { ?>
<a class="sp" href="index.php?name_page=my_data&type=music"> Images  </a>  / <a class="sp" href="index.php?name_page=my_data&type=playlist">Gallary</a>
<?php } 
else if ($_SESSION['page_type']=="video") { ?>
...
<div class="section1  ">
<div class="fleft"><input id="acceptTerms_<?php echo $fetch_playlist_file['int_cat_id']; ?>"  name="acceptTerms_<?php echo $fetch_playlist_file['int_cat_id']; ?>" type="checkbox" onchange="togglecolor(this.value,this.id);"  value="<?php echo $fetch_playlist_file['int_cat_id']; ?>"  /></div>
<div class="icon">

<?php if ($_SESSION['page_type']=="gallary") { ?>
<img src="images/gallery_icon.gif" />
<?php } else if ($_SESSION['page_type']=="video") { ?>
<img src="images/icon_video.png" />
<?php }  
else { ?>
<img src="images/headphones-icon.jpg" />
<?php } ?>
       ...
       <ul id="nav" class="dropdown dropdown-horizontal">
                               ...
                               <li><a href="javascript:void(0);" class="delete_dropdown"></a>
                                       <ul class="position">
                                              ...
                                              <li>
                                              <a href="javascript:void(0);" onclick="open_list_div('<?php echo $fetch_playlist_file['txt_fid']; ?>');">
                                                     <img  src="images/list10.gif" style="width: 10px; height: 10px; " align='texttop' />&nbsp;
                                                    <?php if ($_SESSION['page_type']=="gallary") { ?>
                                                    Show Images
                                                    <?php } 
                                                    else if ($_SESSION['page_type']=="video") { ?>
...
<div class=" icon_sep">
    ...
    <?php
    if($fetch_data['txt_file_type']=="image/jpeg" || $fetch_data['txt_file_type']=="image/png" || $fetch_data['txt_file_type']=="image/gif" || $fetch_data['txt_file_type']=="image/jpg")
     {
        ?>
...
{iddiv="div_"+val;
    ...
    if(document.getElementById(id).checked)
    {
       ...
       document.getElementById(iddiv).style.background="#f0ed94";
    }
    else
...
#search input {
 ...
 <form id="del_form" name="del_form" method="post" action="#">
        ...
        .listdiv {
         ...
         <div class="music_pattern listdiv" id="list_div" style="display: none;height: 250px;">
          <div class="music_close" onclick="document.getElementById('list_div').style.display='none';">
          <img src="image/close_music.png" alt="close" /></div>
         <br />
 ...
 <div class="music_close" onclick="document.getElementById('rename_div').style.display='none';"><img src="image/close_music.png" alt="close" /></div>
