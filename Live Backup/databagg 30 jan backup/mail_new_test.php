...
$content.="<br> <br>";
	...
	$mail->ClearAllRecipients();
       ...
       //$mail_id="saurav.suman@cyfuture.com";
...
mail_welcome("saurav.suman@cyfuture.com","saurav");
mail_welcome_facebook("saurav.suman@cyfuture.com","saurav","pass");
mail_verify("saurav.suman@cyfuture.com","saurav");
mail_forgot("saurav.suman@cyfuture.com","saurav","Pass");
mail_share("saurav.suman@cyfuture.com","code","saurav","suman","saurav.suman@cyfuture.com");
mail_share_category("saurav.suman@cyfuture.com","code","saurav","suman","saurav.suman@cyfuture.com");
mail_share_category_photo("saurav.suman@cyfuture.com","code","saurav","suman","saurav.suman@cyfuture.com");
mail_share_category_video("saurav.suman@cyfuture.com","code","saurav","suman","saurav.suman@cyfuture.com");

mail_download_databagg("saurav.suman@cyfuture.com","saurav");
mail_data_filled("saurav.suman@cyfuture.com","saurav","80%","Ravish");
mail_data_filled_all("saurav.suman@cyfuture.com","saurav","Ravish");
mail_done_hard_work("saurav.suman@cyfuture.com","saurav","Ravish");
mail_complete_setup("saurav.suman@cyfuture.com","saurav");
mail_dedicated_manager("saurav.suman@cyfuture.com","saurav","Manager");
mail_first_sync("saurav.suman@cyfuture.com","saurav","PC123");
?>