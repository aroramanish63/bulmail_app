...
<div class="container" >
  <center>
    <?php
     ...
     {
        ?>
    <div class="success" id="error_container1" style="position: absolute;margin-left: 250px;"> <strong>√</strong> <?php echo $suc_msg; ?> </div>
    <?php
     }
     ?>
  </center>
  ...
  <div id="main" class="fleft">
    <div class="width fright">
      <div class="fullcontainer">
         <h1 >   <label id="46_actstngs">Account Setting</label></h1>
      </div>
      ...
      <div class="settingleft_section">
        ...
        <label id="46_uplodnwpt">Upload a new photo</label><br />
...
.file-holder
{
    ...
    float: left;
       ...
       <form id="uploadpic" name="uploadpic" action="#" method="post" enctype="multipart/form-data" >
        ...
        <span class="button"><label id="46_uplodnwpt">Upload a new photo</label></span>
...
$(document).ready(function() {
 ...
 <div class="upload_text"><label id="46_ntclupwimmre">Note : Clicking "Upload" will immediately replace your profile picture. This cannot be undone.</label></div>
...
<div class="arrow-left"></div> <label id="46_entfirsnam">Enter first name</label>
</div>
<label><label id="46_frtnme">First Name:</label></label>
...
<div class="arrow-left"></div> <label id="46_entyrlstnm">Enter your last name</label>
</div>
        <label><label id="46_lastnme">Last Name:</label></label>
       ...
       <div class="formrow_setting">
        <div class="form_cols fl">
        <label><label id="46_cmpny">Company:</label></label>
         <input type="text" id="txt_company" name="txt_company" value="<?php echo $fetch_user_data['txt_company']; ?>" /></div>
         <div class="form_cols fr">
         <label for="name"><label id="46_desngm">Designation:</label></label>
...
<div class="arrow-left"></div><label id="46_entyphn">Enter your phone</label>
</div>
<label for="name"><label id="46_phne">Phone:</label></label>
 ...
 <div class="arrow-left"></div><label id="46_plseycontr">Please select your country</label>
</div>
       <label for="name"><label id="46_count">Country:</label></label>
      ...
      <div class="form_cols fr">
       <label ><label id="46_address">Address:</label></label>
...
<div class="arrow-left"></div><label id="46_entystnme">Enter your state name</label>
</div>
       <label for="name"><label id="46_stte">State:</label></label>
 ...
 <div class="arrow-left"></div><label id="46_entctynm">Enter your city name</label>
</div>
       
       
      <label for="name"><label id="46_cty">City:</label></label>
...
<div class="arrow-left"></div> <label id="46_entryzipc">Enter your zip-code</label>
</div>
        <label for="name"><label id="46_zp">Zip:</label></label>
 ...
 <div class="arrow-left"></div><label id="46_entoldpass">Enter old password</label>
</div>
       
         <label for="name"><label id="46_oldpass">Old password:</label> </label>
 ...
 <div class="arrow-left"></div><label id="46_enternewpass">Enter new password</label>
</div>
        <label for="name" id="46_nwpswd">New password:</label> 
 ...
 <div class="arrow-left"></div><label id="46_confpamis">Confirm password mismatch</label> 
</div>
        
       <label for="name"><label id="46_confpas">Confirm password:</label>  </label>
        ...
        <input type="hidden" value="<?php echo $_REQUEST['name_page']; ?>" id="name_page" name="name_page" />
                           ...
                           <b>
                          <label id="46_ycaeuuns">You can earn upto unlimited space by referring your friends to Databagg!</label>
                           </b>
                           </font>
                           ...
                           <tr>
                            <th>
                           <label id="46_type">Type</label>
                            </th>
                              <th>
                           <label id="46_eml">E-mail</label>
                            </th>
                           <th>
                          <label id="46_sttus">Status</label>
                           </th>
                           </tr>
                           <?php
                           ...
                           ?>
                            ...
                            <tr>
                            <td>
                            <label id="46_refrel">Referral</label>
                            </td>
                              <td>
                         ...
                         else
                         {
                            ?>
                            <div class="info_err">
                              <label id="46_ydntiyanfr">You did not invite your any friend yet.</label>
                            </div>
                            <?php
                         }
                         ?>
                         <a class="but_getrefferal"  href="https://www.databagg.com/referral/?page=invite" target="_blank" >
