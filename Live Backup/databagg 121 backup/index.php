...
<div style="float:left; margin-top:30px; margin-right:20px;"><a href="#"><img onclick="location.href='../../DataBaGG.exe';" src="share/images/install-img.png" onmouseover="this.src='share/images/install-img-o.png';" onmouseout="this.src='share/images/install-img.png';" style="cursor:pointer;"  alt="#" /></a></div>           
 <?php
 ...
 <div class="file_name" style="margin-top: 7px;"><?php if($flag=="false") echo "There is no item for Share! Thank you."; else echo $fetch_share_link['txt_cat_name']; ?></div>
...
<input class="submit" type="button" value=""  onclick="valid();" />
...
$lnk="http://www.databagg.com/user/category/ishare/?code=".$_REQUEST['code'];
else if($fetch_share_link['txt_cat_type']=="Video")
$lnk="http://www.databagg.com/user/category/vshare/?code=".$_REQUEST['code'];
else
$lnk="http://www.databagg.com/user/category/share/?code=".$_REQUEST['code'];
 ?>
<a target="_blank" href="http://www.facebook.com/sharer.php?u=<?php echo $lnk; ?>">
<img src="images/facebook-icon.jpg" width="64px" height="64px" title="Share this on Facebook"  /></a>
<a target="_blank" href="http://twitter.com/share?text='File shared @ Databagg&url=<?php echo $lnk; ?>'">
<img src="images/twitter-icon.jpg" width="64px" height="64px" title="Share this on Twitter" style="padding-left: 10px;" /></a>
<a target="_blank" href="
http://www.linkedin.com/shareArticle?mini=true&url=<?php echo $lnk; ?>&title=Share on databagg&summary=<?php echo $lnk; ?>&source=databagg">
...
<style>
.submit {
   background:url(share/images/butsend.png);
...
.submit:hover{ background-position:left -34px;}
</style>
<script type="text/javascript">
function altRows(id){
...
<ul id="footer" class="fleft">
    <li><a href="../../term-of-services.php" class="active" target="_blank">Terms</a></li>
    <li><a href="../../privacy-policy.php" target="_new" style="border:none;" target="_blank">Privacy Policy</a></li>
    </ul> </div>
    <div class="call_us"><img src="../image/footer-right.png" alt="call_us" />
