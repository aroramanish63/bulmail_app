...
<div class="container_12">
            ...
            <div class="grid_7">
                ...
                <a href="<?php echo SITE_URL; ?>?page=categories" class="dashboard-module">
...
<!--                <a href="<?php echo SITE_URL; ?>?page=profile" class="dashboard-module">
            ...
            <div class="grid_5">
                <div class="module">
                        ...
                        <div class="module-body">
                        	...
                        	<p>
                                    <strong>User: </strong><?php echo ucwords($_SESSION['username']); ?><br />
