...
<p class="not-found">Not<br/>
  Found</p>
<div class="clear"></div>
<div class="content"> The page your are looking for is not found. <br/>
  <a href="<?php echo $cfg['site_url']; ?>">Go Home</a> or<br/>
  <form method="get" action="<?php echo $cfg['site_url'];?>">
    Search<br/>
