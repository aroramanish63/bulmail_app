...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
        ...
        <div id="header">
			...
			else if(isset($_REQUEST['page']) && ($_REQUEST['page']=='categories' || $_REQUEST['page']=='subcategory' || $_REQUEST['page']=='sites')){
				unset($_SESSION['home_menu']);
				unset($_SESSION['emails_menu']);
				unset($_SESSION['profile_menu']);
				unset($_SESSION['settings_menu']);
				$_SESSION['category_menu'] = 'current';
			}
			else if(isset($_REQUEST['page']) && ($_REQUEST['page']=='emails' || $_REQUEST['page'] == 'exportemail')){
				unset($_SESSION['category_menu']);
				unset($_SESSION['home_menu']);
				unset($_SESSION['profile_menu']);
				unset($_SESSION['settings_menu']);
                       ...
                       <!--<div class="headerlogo" style="width:auto; float:left; "><img src="images/bsnl_logo.jpg" alt="#" /></div>-->
       					<div style="width:100%; float:left;">                
                            <ul id="nav">                               
                                ...
                                <li id="<?php echo $_SESSION['category_menu']; ?>"><a href="?page=categories">Categories</a></li>
